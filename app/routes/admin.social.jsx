...
export const meta = () => {
  return [{title: 'WornVault | Admin Social Links'}];
};
...
export async function loader({request, context}) {
  // Defense in depth: Verify admin auth
...
/**
 * Social media icon components matching creator.social-links.jsx style
 */
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            Manage and view social media platform information.
          </p>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <IconComponent className="h-8 w-8 text-gray-700 dark:text-gray-300" aria-hidden="true" />
                ...
                {/* Empty container */}
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6 min-h-[200px]">
...
/** @typedef {import('./+types/admin.social').Route} Route */
