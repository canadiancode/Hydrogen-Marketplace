...
/**
 * Generate JSON-LD structured data for the fees and payouts page
...
function generateStructuredData(baseUrl) {
  return {
    ...
    '@type': 'Article',
    headline: 'WornVault — Fees & Payouts',
    description: 'Learn about WornVault pricing, fees, and payout structure. Transparent 15% creator fee includes full end-to-end order handling, shipping, and fulfillment.',
    author: {
      '@type': 'Organization',
      name: 'WornVault',
    },
...
export const meta = ({request}) => {
  ...
  const canonicalUrl = `${baseUrl}/fees-payouts`;
  
  return [
    {title: 'Fees & Payouts | WornVault'},
    {
      name: 'description',
      content: 'Learn about WornVault pricing, fees, and payout structure. Transparent 15% creator fee includes full end-to-end order handling, shipping, and fulfillment.',
    },
    {rel: 'canonical', href: canonicalUrl},
    {property: 'og:title', content: 'Fees & Payouts | WornVault'},
    {
      property: 'og:description',
      content: 'Learn about WornVault pricing, fees, and payout structure.',
    },
...
export async function loader({request}) {
  ...
  try {
    ...
    if (duration > 100) {
      console.warn(`Slow loader: fees-payouts took ${duration}ms`);
    }
        ...
        <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
          ...
          <div className="mb-8">
            <Breadcrumbs 
              items={[
                ...
                {name: 'Fees & Payouts', href: '/fees-payouts', current: true},
              ]}
            />
          </div>
          ...
          <div className="mb-12 pb-8 border-b border-gray-200 dark:border-gray-700">
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              WornVault is designed to remove friction, not add it.
            </p>
            <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed">
              Our pricing is built around eliminating operational, emotional, and privacy-related overhead so creators can sell without stress, exposure, or logistics management.
            </p>
          </div>
          ...
          <section className="mb-12 pb-8 border-b border-gray-200 dark:border-gray-700">
            ...
            <p className="text-base text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
              All items must be priced at <strong className="font-semibold text-gray-900 dark:text-white">$100 or higher</strong>.
            </p>
            <p className="text-base text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 mt-4">
              <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed font-medium">
                This is not a listing fee.
              </p>
              <p className="text-base text-gray-700 dark:text-gray-300 mt-2 leading-relaxed">
                It is a quality and sustainability threshold that allows WornVault to manage each transaction end-to-end without compromise.
              </p>
            </div>
          </section>
          ...
          {/* Oversized or Heavy Items Section */}
          <section className="mb-12 pb-8 border-b border-gray-200 dark:border-gray-700">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-0">
              Oversized or Heavy Items
            </h2>
            <p className="text-base text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
              Items with exceptionally high fulfillment costs may require an adjusted take-rate.
            </p>
            <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed">
              This applies only when shipping and handling costs materially exceed the standard fee.
              Any adjusted rate is clearly communicated before the item goes live.
            </p>
          </section>
...
/**
 * Error boundary for fees and payouts page
...
/** @typedef {import('./+types/fees-payouts').Route} Route */
