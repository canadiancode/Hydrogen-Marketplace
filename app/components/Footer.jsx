      ...
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.thingsYouCanBuy.map((item) => (
                    <li key={item.name}>
                      <Link
                        to={item.href}
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-sm/6 font-semibold text-gray-900 dark:text-white">How It Works</h3>
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.howItWorks.map((item) => (
                    <li key={item.name}>
                      <Link
                        to={item.href}
                        className="text-sm/6 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm/6 font-semibold text-gray-900 dark:text-white">Creators</h3>
                <ul role="list" className="mt-6 space-y-4">
        ...
        <div className="mt-8 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between dark:border-white/10">
          ...
          <p className="mt-8 text-sm/6 text-gray-600 md:order-1 md:mt-0 dark:text-gray-400">
            &copy; {new Date().getFullYear()} WornVault, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
